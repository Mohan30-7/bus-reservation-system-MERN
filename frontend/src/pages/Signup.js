...
function Signup() {
    ...
    const handleSignup = async e => {
        ...
        try {
            ...
            else { alert('Signup successful'); navigate('/'); }
    ...
    return (
        <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <div style={{ width: 420, background: '#fff', padding: 35, borderRadius: 20, boxShadow: '0 20px 40px rgba(0,0,0,0.15)', textAlign: 'center' }}>
                ...
                <p style={{ marginBottom: 25, color: '#666' }}>Sign up to book bus tickets</p>
                ...
                <p style={{ marginTop: 20 }}>Already have an account? <Link to="/" style={{ color: '#e53935', fontWeight: 'bold' }}>Login</Link></p>
            </div>
        </div>
    );
}
